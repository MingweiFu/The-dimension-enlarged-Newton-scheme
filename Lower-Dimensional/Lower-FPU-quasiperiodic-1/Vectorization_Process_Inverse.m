...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Input:                                                             %%%
%%% vec_reduced: L_next^2 x n - m vector, which is reduced             %%% 
...
function tensor_ori = Vectorization_Process_Inverse(vec_reduced, A_next, n, torus_idx)
...
for j = 1 : m
    ...
    mask_tensor(row_idx, col_idx, torus_idx(j)) = false;
end
