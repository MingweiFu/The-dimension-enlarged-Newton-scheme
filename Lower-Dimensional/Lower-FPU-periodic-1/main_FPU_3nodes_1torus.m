...
%%% the chosen torus is m(=1).                                         %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%


% Dimension-enlarged Newton iteration for the FPU system with n=3 mass points and m=1 dimensional-torus
clear; 
clc;
...
torus_idx = 1;                   % Index of the chosen basic torus
...
% 
% % Decoration and axis settings for component 1: q1 - p1
% axis([-2.5*1e-16, 2.5*1e-16, -2.5*1e-16, 2.5*1e-16]);
% axis square; 
% box on;
% 
% % Unify axes box position and size for all plots
...
% xtickformat('%.2f');
% ytickformat('%.2f');
% xtick_values = linspace(-2.5*1e-16, 2.5*1e-16, 5);
% ytick_values = linspace(-2.5*1e-16, 2.5*1e-16, 5);
% set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
% set(gca,'fontsize',30)
% legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);
% 
% % Mark positions at time t = 0, 10, 20
% text(1.3*1e-16, 0.0*1e-16, '$t = 0$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(-0.5*1e-16, 2.1*1e-16, '$t = 10$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(-1*1e-16, -1.4*1e-16, '$t = 20$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')




%%%%%%%%%%%%%%%%%%% settings of the third basic torus %%%%%%%%%%%%%%%%%%%%
...
% xtickformat('%.1f');
% ytickformat('%.1f');
% xtick_values = linspace(-0.2, 0.2, 5);
% ytick_values = linspace(-0.2, 0.2, 5);
% set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
% set(gca,'fontsize',30)
% legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);
% 
...
axis([-1.5*1e-17, 1.5*1e-17, -1.5*1e-17, 1.5*1e-17]);
axis square; 
box on;
...
xtickformat('%.2f');
ytickformat('%.2f');
xtick_values = linspace(-1.5*1e-17, 1.5*1e-17, 5);
ytick_values = linspace(-1.5*1e-17, 1.5*1e-17, 5);
set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
set(gca,'fontsize',30)
legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);

% Mark positions at time t = 0, 10, 20
text(-0.85*1e-17, 0, '$t = 0$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
text(0.4*1e-17, -0.2*1e-17, '$t = 10$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
text(-0.74*1e-17, -0.74*1e-17, '$t = 20$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
...
% 
% % Decoration and axis settings for component 2: q2 - p2
% axis([-1.5*1e-15, 1.5*1e-15, -1.5*1e-15, 1.5*1e-15]);
% axis square; 
% box on;
% 
% % Unify axes box position and size for all plots
...
% xtickformat('%.2f');
% ytickformat('%.2f');
% xtick_values = linspace(-1.5*1e-15, 1.5*1e-15, 5);
% ytick_values = linspace(-1.5*1e-15, 1.5*1e-15, 5);
% set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
% set(gca,'fontsize',30)
% legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);
% 
% % Mark positions at time t = 0, 10, 20
% text(0.75*1e-15, 0.0, '$t = 0$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(0.7*1e-15, 0.45*1e-15, '$t = 10$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(0.5*1e-15, 0.9*1e-15, '$t = 20$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
...
xtickformat('%.2f');
ytickformat('%.2f');
xtick_values = linspace(-0.1, 0.1, 5);
ytick_values = linspace(-0.1, 0.1, 5);
set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
set(gca,'fontsize',30)
legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);
...
text(-0.055, 0, '$t = 0$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
text(0.04, -0.035, '$t = 10$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
text(-0.065, -0.05, '$t = 20$', ...
    'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
...
% 
% % Decoration and axis settings for component 3: q3 - p3
% axis([-2.5*1e-17, 2.5*1e-17, -2.5*1e-17, 2.5*1e-17]);
% axis square; 
% box on;
% 
% % Unify axes box position and size for all plots
...
% xtickformat('%.2f');
% ytickformat('%.2f');
% xtick_values = linspace(-2.5*1e-17, 2.5*1e-17, 5);
% ytick_values = linspace(-2.5*1e-17, 2.5*1e-17, 5);
% set(gca, 'XTick', xtick_values, 'YTick', ytick_values);
% set(gca,'fontsize',30)
% legend('Location', 'northeast','Interpreter', 'latex', 'FontSize', 25);
% 
% % Mark positions at time t = 0, 10, 20
% text(1*1e-17, 0.0*1e-17, '$t = 0$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(-1.25*1e-17, 1.9*1e-17, '$t = 10$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
% text(-1.35*1e-17, -0.9*1e-17, '$t = 20$', ...
%     'Interpreter', 'latex', 'FontSize', 30, 'FontWeight', 'bold')
