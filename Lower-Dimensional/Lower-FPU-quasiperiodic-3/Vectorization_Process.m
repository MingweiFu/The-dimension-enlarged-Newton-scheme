...
function [tensor_nan, comp_full_nan, vec_tot_nan, vec_reduced] = Vectorization_Process(tensor_ori, A_next, n, torus_idx)
...
for j = 1 : m
    tensor_nan(res_idx(j, 1) + A_next + 1, res_idx(j, 2) + A_next + 1, torus_idx(j)) = nan;
end
